...
class MODOficinaReclamo extends MODbase{
    ...
    function listarOficina(){
        ...
        $this->procedimiento='rec.ft_oficina_sel';
        $this->transaccion='REC_OFI_SEL';
    ...
    function insertarOficina(){
        ...
        $this->procedimiento='rec.ft_oficina_ime';
        $this->transaccion='REC_OFI_INS';
