...
class MODRespuesta extends MODbase{
	...
	function listarRespuesta(){
		...
		$this->procedimiento='recl.ft_respuesta_sel';
		$this->transaccion='RECL_RES_SEL';
	...
	function insertarRespuesta(){
		...
		$this->procedimiento='recl.ft_respuesta_ime';
		$this->transaccion='RECL_RES_INS';
