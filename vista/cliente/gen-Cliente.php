...
Phx.vista.Cliente=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'cli.cli_correo',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'cli.cli_nombre',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
	...
	tam_pag:50,	
	title:'Cliente',
	ActSave:'../../sis_reclamos/control/Cliente/insertarCliente',
	ActDel:'../../sis_reclamos/control/Cliente/eliminarCliente',
	ActList:'../../sis_reclamos/control/Cliente/listarCliente',
	id_store:'cli_id',
	fields: [
		{name:'cli_id', type: 'string'},
		{name:'estado_reg', type: 'string'},
		{name:'cli_correo', type: 'string'},
