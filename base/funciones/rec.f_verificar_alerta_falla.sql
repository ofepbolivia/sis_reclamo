...
BEGIN
    ...
    IF (p_transaccion = 'FAILED_MAILS')THEN
        ...
        FOR v_record_ids IN (SELECT count(ta.id_alarma) AS contador, tr.id_respuesta, tr.id_reclamo
          ...
          SELECT rec.nro_tramite, rec.id_proceso_wf, rec.id_estado_wf
          INTO v_record_rec
        ...
        IF(v_record_ids.contador > 0)THEN
          ...
          FOR v_index IN 1..array_length(v_ids_alarma,1) LOOP
              ...
              UPDATE param.talarma  SET
                ...
                desc_falla = '',
                pendiente = 'no',
                correos = 'sac@boa.bo,(franklin.espinoza@boa.bo)'
