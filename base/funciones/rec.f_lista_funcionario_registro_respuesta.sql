CREATE OR REPLACE FUNCTION rec.f_lista_funcionario_registro_respuesta (
...
BEGIN
	...
	WHERE tte.codigo =  'elaboracion_respuesta' AND tew.id_proceso_wf = (SELECT tew.id_proceso_wf
																		 FROM wf.testado_wf tew
