CREATE OR REPLACE FUNCTION rec.ft_oficina_sel (
...
$body$
  ...
  ***************************************************************************/
  ...
  BEGIN
    ...
    v_nombre_funcion = 'rec.ft_oficina_sel';
    v_parametros = pxp.f_get_record(p_tabla);

    /*********************************
     #TRANSACCION:  'REC_OFI_SEL'
     #DESCRIPCION:	Consulta de datos
     #AUTOR:		admin
     #FECHA:		15-01-2014 16:05:34
    ***********************************/

    if(p_transaccion='REC_OFI_SEL')then
    ...
    /*********************************
     #TRANSACCION:  'REC_OFI_CONT'
     #DESCRIPCION:	Conteo de registros
     #AUTOR:		F.E.A.
     #FECHA:		15-01-2014 16:05:34
    ***********************************/

    elsif(p_transaccion='REC_OFI_CONT')then
